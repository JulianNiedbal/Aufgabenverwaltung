...
public class PostgresTaskServiceTests {

    @Autowired
    PostgresTaskService taskService;

    @AfterEach
    void tearDown() {
        taskService.deleteAllTasksByOwnerUsername("JulianNiedbal");
        taskService.deleteAllTasksByOwnerUsername("User A");
        taskService.deleteAllTasksByOwnerUsername("User B");
        taskService.deleteAllTasksByOwnerUsername("User C");
    }
